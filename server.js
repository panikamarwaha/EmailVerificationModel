...
mongoose.connect('mongodb://127.0.0.1:27017/Blog', {
  ...
  useUnifiedTopology: true, // handle newer MongoDB features
});
...
function sendOTP(email, otp) {  // two parameters
  const transporter = nodemailer.createTransport({  // used to send mail
    service: 'gmail',
    auth: {
      user: 'marwahapanika@gmail.com', // Your Gmail email address
      pass: 'djqj qhyu fhzj eujr', // Your Gmail app password
    },
  });

  const mailOptions = {
    from: 'marwahapanika@gmail.com',
    to: email,
